...
<div class="nav-scroller py-1 mb-4 bg-light border-bottom navbar-dark">
    <div class="container">
        <nav class="nav d-flex justify-content-between">
            ...
            <a class="p-2 text-muted{{ Request::is('uitrukken*') ? ' font-weight-bold' : '' }}" href="/uitrukken">
                Uitrukken
            </a>
            <a class="p-2 text-muted{{ Request::is('p2000*') ? ' font-weight-bold' : '' }}" href="/p2000">
                P2000
            </a>
            <a class="p-2 text-muted{{ Request::is('contact*') ? ' font-weight-bold' : '' }}" href="/contact">
                Contact
            </a>
        </nav>
    </div>
